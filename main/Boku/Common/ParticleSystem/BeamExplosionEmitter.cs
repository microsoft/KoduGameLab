...
namespace Boku.Common.ParticleSystem
{
    ...
    public class BeamExplosionEmitter : BaseSpriteEmitter
    {
        ...
        // c'tor
        public BeamExplosionEmitter(ParticleSystemManager manager)
            : base(manager)
        {
        ...
        {
            // Load the texture.
            if (BeamExplosionEmitter.texture == null)
            {
                BeamExplosionEmitter.texture = BokuGame.Load<Texture2D>(BokuGame.Settings.MediaPath + @"Textures/BeamFire");
            }
        ...
        {
            BeamExplosionEmitter.texture = null;
