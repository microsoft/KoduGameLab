...
namespace KoiX.UI
{
    ...
    public class NextButton : BaseButton
    {
        ...
        static string textureName = @"KoiXContent\Textures\RightArrow";
        ...
        public NextButton(BaseDialog parentDialog, RectangleF rect, string labelId = null, string labelText = null, Callback onSelect = null, ThemeSet theme = null)
        ...
        public override void Render(SpriteCamera camera, Vector2 parentPosition)
        {
            if (Active && !Disabled)
            {
                ...
                if (gamepadAlpha.Value > 0)
                {
                    ...
                    Padding padding = new UI.Padding(16, 16, 64, 16);
                    RoundedRect.Render(camera, rect, radius, Theme.CurrentThemeSet.DisabledLightColor * gamepadAlpha.Value,
                                ...
                                texture: Textures.Get("GamePad RightBumper"), texturePadding: padding);
                }
                if (label != null)
                {
                    label.Position = localRect.Position - new Vector2(labelWidth, 0);
                }
        ...
        public override bool ProcessGamePadEvent(GamePadInput pad)
        {
            ...
            if (pad.RightShoulder.WasPressed)
            {
                OnButtonSelect();
