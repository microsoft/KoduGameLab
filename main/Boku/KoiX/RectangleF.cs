...
namespace KoiX
{
    ...
    public struct RectangleF
    {
        ...
        static public RectangleF EmptyRect = new RectangleF();
        ...
        /// <summary>
        /// Avoids issues with RectangleF being a struct rather than a class.
        /// With this I can write label.LocalRect.SetSize = foo;
        /// Without this, label.LocalRect.Size = foo; fails since LocalRect.Size
        /// returns a Vector2 struct rather than an a class.
        /// </summary>
        ...
        /// <param name="rect1"></param>
        /// <returns></returns>
        public static RectangleF Union(RectangleF rect0, RectangleF rect1)
        {
            RectangleF result = new RectangleF();
        ...
        /// <summary>
        /// Expands rectangle in each direction by given amount.
        /// </summary>
        ...
        /// <summary>
        /// Inflates/defaltes the rect based on the padding values.
        /// Positive values grow the size of the rect, negative values 
        /// shrink it.
        /// </summary>
