...
namespace KoiX.Text
{
    ...
    public static partial class SysFont
    {
        ...
        public class CacheEntry
        {
            ...
            public const int MaxEntries = 32;   // Generally not needed to be this big but it makes some UI elements work better without having to rewrite them.  (Language radio buttons...)
