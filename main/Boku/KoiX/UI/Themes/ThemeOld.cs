...
namespace KoiX.UI
{
    ...
    /// <summary>
    /// Colors, sizes, styles etc for UI elemetns.
    /// </summary>
    public class ThemeOld
    {
        public static float TwitchTime = 0.2f;          // Time used by most things.
        public static float QuickTwitchTime = 0.1f;     // Time used for smaller changes.
        ...
        // Buttons
        public static float ButtonFontSize = 18.0f;
        public static SystemFont ButtonFont = SysFont.GetSystemFont(TextFontFamily, 18.0f, FontStyle.Regular);
