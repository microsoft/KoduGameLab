...
namespace Boku.UI2D
{
    ...
    public class UIGridIntegerSliderElement : UIGridBaseSliderElement
    {
        ...
        /// </summary>
        public UIGridIntegerSliderElement(float width, float height, float edgeSize, string normalMapName, Color baseColor, String label, GetFont font, TextHelper.Justification justify, Color textColor)
        ...
        /// </summary>
        public UIGridIntegerSliderElement(float width, float height, float edgeSize, string normalMapName, Color baseColor, String label, GetFont font, TextHelper.Justification justify, Color textColor, Color dropShadowColor, bool invertDropShadow)
