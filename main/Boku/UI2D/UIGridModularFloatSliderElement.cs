...
namespace Boku.UI2D
{
    ...
    public class UIGridModularFloatSliderElement : UIGridBaseModularSliderElement
    {
        ...
        /// </summary>
        public UIGridModularFloatSliderElement(float width, float height, float edgeSize, string normalMapName, Color baseColor, string label, Shared.GetFont font, Justification justify, Color textColor, Color dropShadowColor, bool invertDropShadow)
