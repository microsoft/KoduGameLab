...
namespace Boku.Web.Trans
{
    ...
    /// </summary>
    public class VerifyUser : CommunityRequest
    {
        protected override string MethodName { get { return "VerifyUser"; } }
        ...
        public VerifyUser(SendOrPostCallback callback, object userState)
        ...
        protected override bool ISend()
        {
            ...
            Message_VerifyUserRequest request = new Message_VerifyUserRequest();
            ...
            try
            {
                ...
                if (success)
                {
                    if (DeSoapify(ref str))
                    {
                        ...
                        Message_VerifyUserReply reply = Message_VerifyUserReply.Load(buffer);
