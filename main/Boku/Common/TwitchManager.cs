...
namespace Boku.Common
{
    ...
    public class TwitchManager
    {
        ...
        /// <param name="onComplete">Event handler triggered when twitch completes (or is terminated).</param>
        public static int CreateTwitch<T>(T startValue, T targetValue, Set<T> set, double duration, TwitchCurve.Shape shape, Object param, TwitchCompleteEvent onComplete) where T : struct
        {
            return Twitch<T>.CreateTwitch(startValue, targetValue, set, duration, shape, param, onComplete, null, false);
        }
        ...
        public static int CreateTwitch<T>(T startValue, T targetValue, Set<T> set, double duration, TwitchCurve.Shape shape, Object param, TwitchCompleteEvent onComplete, TwitchCompleteEvent onTerminate) where T : struct
        {
            return Twitch<T>.CreateTwitch(startValue, targetValue, set, duration, shape, param, onComplete, onTerminate, false);
        }
        ...
        /// <param name="onTerminate">Event handler triggered when twitch is terminated.</param>
        /// <param name="useGameTime">By default twitches used WallClockTime since they're generally used for UI.  Set this to true if you want the twitch to run off of GameTime</param>
        public static int CreateTwitch<T>(T startValue, T targetValue, Set<T> set, double duration, TwitchCurve.Shape shape, Object param, TwitchCompleteEvent onComplete, TwitchCompleteEvent onTerminate, bool useGameTime) where T : struct
        {
