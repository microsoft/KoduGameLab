...
namespace Boku.Web.Trans
{
    ...
    /// </summary>
    public class GetWorldPage : CommunityRequest
    {
        protected override string MethodName { get { return "GetWorldPage"; } }
            ...
            try
            {
                ...
                if (success)
                {
                    if (DeSoapify(ref str))
                    {
                        ...
                        Message_GetWorldPageReply reply = Message_GetWorldPageReply.Load(buffer);
